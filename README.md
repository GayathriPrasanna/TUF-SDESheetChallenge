...
📚 Solving 3 problems daily from TUF-SDE Sheet  
💻 Language: Java  
🔥 Goal: Consistency + Strong DSA  
...
💻 Solution: https://github.com/GayathriPrasanna/TUF-SDESheetChallenge/blob/main/Day-1/Arrays/set-matrix-zeroes.java  
